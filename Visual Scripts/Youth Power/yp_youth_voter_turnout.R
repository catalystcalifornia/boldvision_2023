...
fx_barchart_subgroup(
  ...
  caption_datasource = "Catalyst California's calculations of IPUMS Current Population Survey Voting Supplement, pooled estimates from 2014, 2016, 2018, 2020.",
  ...
  caption_indicator_def = "Eligible youth voter turnout is defined as youth citizens, ages 18-29 years, who voted during presidential and midterm elections.",
