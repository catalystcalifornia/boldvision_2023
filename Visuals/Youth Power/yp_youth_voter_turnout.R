...
fx_barchart_subgroup(
  ...
  subtitle = "Percent of Youth Eligible Voter Turnout During Presidential and Midterm Elections by Race in Los Angeles County",
  #please follow the format of the datasource below
  caption_datasource = "Data downloaded from IPUMS CPS Voting Supplement. Samples from 2014, 2016, 2018, and 2020 were pooled to calculated turnout by race-ethnicity.",
  ...
  caption_indicator_def = "Eligible Youth Voters are defined as adult citizens, age range 18-29 years.",
