...
fx_barchart_subgroup(
  ...
  title = "The majority of youth in LA County are healthy, Latine and AIAN Youth on average experience poorer health status",
  #explanation of what the we are looking at // use sentence case 
  subtitle = "Percent of youth reporting an excellent/very good/good health status",
