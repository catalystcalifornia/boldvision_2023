...
fx_barchart_subgroup(
  ...
  title = "Foster care and  probation populations are most likely to comprise of Black and AIAN youth",
  #explanation of what the we are looking at // use sentence case 
  subtitle = "Average rates per 1K of youth in foster care / probation in Los Angeles County",
